...
// changeable
#define FTDefaultMargin                     14.f
#define FTDefaultMenuTextMargin             15.f
#define FTDefaultMenuIconMargin             6.f
#define FTDefaultMenuCornerRadius           17.f
...
#define FTDefaultTintColor                  [UIColor colorWithRed:235/255.f green:235/255.f blue:235/255.f alpha:1.f]
...
#define FTDefaultSeparatorColor             [UIColor colorWithRed:170/255.f green:170/255.f blue:170/255.f alpha:0.3]
//#define FTDefaultSeparatorColor             [UIColor colorWithRed:239/255.f green:239/255.f blue:239/255.f alpha:0.5]
#define FTDefaultMenuFont                   [UIFont systemFontOfSize:15.f]
...
#define FTDefaultMenuArrowHeight            5.f
#define FTDefaultMenuArrowWidth_R           12.f
#define FTDefaultMenuArrowHeight_R          12.f
#define FTDefaultMenuArrowRoundRadius       0.f
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.textFont = [UIFont fontWithName:@"PROXIMANOVA-REGULAR" size:16];
...
- (void)setupWithMenuName:(NSString *)menuName menuImage:(id)menuImage selected:(BOOL)selected {
    ...
    self.menuNameLabel.textColor = [UIColor blackColor];
...
- (UITableView *)menuTableView {
    if (!_menuTableView) {
        ...
        _menuTableView.backgroundColor = [[UIColor alloc] initWithRed:48 green:48 blue:48 alpha:1.0];
