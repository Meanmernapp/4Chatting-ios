...
//  NSURL *broadcastURL = [NSURL URLWithString:[NSString stringWithFormat:@"https://appr.tc/r/%@", _roomNameField.text]];
    NSURL *broadcastURL = [NSURL URLWithString:[NSString stringWithFormat:@"%@/r/%@",[[NSUserDefaults standardUserDefaults]valueForKey:@"web_rtc_web"], _roomNameField.text]];
...
- (void)userDidCancelSetup {
  ...
  [self.extensionContext cancelRequestWithError:[NSError errorWithDomain:@"com.google.AppRTCMobile" code:-1
                                                                userInfo:nil]];
}
