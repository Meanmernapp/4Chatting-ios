...
//        self.navigationView.applyGradient()
    ...
    func initialSetup(){
        ...
        self.callslabel.config(color: TEXT_PRIMARY_COLOR, size: 20, align: .left, text: "calls1")
        callslabel.font = UIFont.boldSystemFont(ofSize: 22.0)
        callslabel.textColor = UIColor.init(named: "Color")
        self.refreshList()
...
//            let headerLabel = UILabel(frame: CGRect(x: 20, y: 30, width:
