...
class SVUploader: UIView {
    ...
    // Image assets
    var successImage = UIImage(named: "")
    ...
    var lineColor = UIColor(red:255.0/255.0, green:140.0/255.0, blue:0/255.0 , alpha:1.0){ //UIColor(red:0.40, green:0.47, blue:0.97, alpha:1.0) {
    ...
    var progress: CGFloat {
        ...
        set {
            ...
            loadingLabel.backgroundColor = UIColor.orange
        }
    }
